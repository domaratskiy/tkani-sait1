...
<form method="post" class="register">
	<?php if ( 'no' === get_option( 'woocommerce_registration_generate_username' ) ) : ?>
		...
		<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide form_p-margin">
	...
	<p class="woocommerce-FormRow form-row">
		...
		<button type="submit" class="woocommerce-Button button tkani-logreg" name="register"

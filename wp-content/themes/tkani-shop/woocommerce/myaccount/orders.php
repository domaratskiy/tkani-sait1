...
<?php if ( $has_orders ) : ?>
	...
	<table class="tkani_table tkani-margin woocommerce-orders-table woocommerce-MyAccount-orders shop_table shop_table_responsive my_account_orders account-orders-table">
		<thead>
			<tr>

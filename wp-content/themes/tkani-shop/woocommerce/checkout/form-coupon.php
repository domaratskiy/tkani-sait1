...
?>
<div class="woocommerce-form-coupon-toggle tkani-woocommerce-form-coupon-toggle">
...
<form class="checkout_coupon woocommerce-form-coupon tkani-woocommerce-form-coupon" method="post" style="display:none">
